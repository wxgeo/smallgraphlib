...
extensions = [
    ...
    "sphinx.ext.napoleon",
    "sphinx_autodoc_typehints",  # Add 'sphinx_autodoc_typehints' *AFTER* 'sphinx.ext.napoleon'
    "myst_parser",
]
...
htmlhelp_basename = "SmallGraphLibdoc"
...
man_pages = [(master_doc, "smallgraphlib", "SmallGraphLib Documentation", [author], 1)]
